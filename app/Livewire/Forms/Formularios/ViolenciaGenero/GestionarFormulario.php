...
class GestionarFormulario extends Form
{
    ...
    { 
        $formulario = FormularioViolenciaGenero::find($id_formulario);
        $this->pregunta_b8_1 = $formulario->pregunta_b8_1;
        $this->pregunta_b8_2 = $formulario->pregunta_b8_2;
        $this->pregunta_b8_3 = $formulario->pregunta_b8_3;
    ...
    {
        $formulario = FormularioViolenciaGenero::find($this->id_formulario);

        $formulario->update([
            'pregunta_b8_1'          => $this->pregunta_b8_1,
            'pregunta_b8_2'          => $this->pregunta_b8_2,
            'pregunta_b8_3'          => $this->pregunta_b8_3,
