...
class GestionarFormulario extends Form
{
    ...
    { 
        $formulario = FormularioRUMV::find($id_formulario);
        $this->pregunta_b1_1 = $formulario->pregunta_b1_1;
        $this->pregunta_b1_2 = $formulario->pregunta_b1_2;
        $this->pregunta_b1_3 = $formulario->pregunta_b1_3;
        $this->pregunta_b1_4 = $formulario->pregunta_b1_4;
    ...
    {
        $formulario = FormularioRUMV::find($this->id_formulario);

        $formulario->update([
            'pregunta_b1_1'          => $this->pregunta_b1_1,
            'pregunta_b1_2'          => $this->pregunta_b1_2,
            'pregunta_b1_3'          => $this->pregunta_b1_3,
            'pregunta_b1_4'          => $this->pregunta_b1_4,
