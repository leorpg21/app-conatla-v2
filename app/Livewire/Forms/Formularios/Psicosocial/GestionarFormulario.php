...
namespace App\Livewire\Forms\Formularios\Psicosocial;
...
class GestionarFormulario extends Form
{
    ...
    public $pregunta_b12_1;

    #[Validate('required|string|in:si,no')]
    public $pregunta_b12_2;

    #[Validate('required|string|in:si,no')]
    public $pregunta_b12_3;
    
    #[Validate('required|string|in:si,no')]
    public $pregunta_b12_4;
    ...
    { 
        $formulario = FormularioPsicosocial::find($id_formulario);
        $this->pregunta_b12_1 = $formulario->pregunta_b12_1;
        $this->pregunta_b12_2 = $formulario->pregunta_b12_2;
        $this->pregunta_b12_3 = $formulario->pregunta_b12_3;
        $this->pregunta_b12_4 = $formulario->pregunta_b12_4;
    ...
    {
        $formulario = FormularioPsicosocial::find($this->id_formulario);

        $formulario->update([
            'pregunta_b12_1'         => $this->pregunta_b12_1,
            'pregunta_b12_2'         => $this->pregunta_b12_2,
            'pregunta_b12_3'         => $this->pregunta_b12_3,
            'pregunta_b12_4'         => $this->pregunta_b12_4,
