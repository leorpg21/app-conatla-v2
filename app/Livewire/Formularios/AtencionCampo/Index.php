...
class Index extends Component
{
   use WithPagination;
    ...
    public $route_encuesta = "atencion_campo.encuesta";
    public $route_ver_encuesta = "atencion_campo.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioAtencionCampo::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    public function render()
    {
        ...
        return view('livewire.formularios.atencion-campo.index', [
