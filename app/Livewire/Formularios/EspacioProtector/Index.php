...
use App\Livewire\Forms\Formularios\EspacioProtector\AgregarObservacion;
...
class Index extends Component
{
    ...
    public $route_encuesta = "espacio_protector.encuesta";
    public $route_ver_encuesta = "espacio_protector.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioEspacioProtector::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    {
        $beneficiarios = FormularioEspacioProtector::with('beneficiario')
        ...
        return view('livewire.formularios.espacio-protector.index', [
