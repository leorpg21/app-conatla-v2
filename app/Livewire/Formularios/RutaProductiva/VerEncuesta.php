...
class VerEncuesta extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->pregunta_b5_1 = !empty($formulario->pregunta_b5_1) ? $formulario->pregunta_b5_1 : 'Información no registrada';
        $this->pregunta_b5_2 = !empty($formulario->pregunta_b5_2) ? $formulario->pregunta_b5_2 : 'Información no registrada';
        $this->pregunta_b5_3 = !empty($formulario->pregunta_b5_3) ? $formulario->pregunta_b5_3 : 'Información no registrada';
        $this->pregunta_b5_4 = !empty($formulario->pregunta_b5_4) ? $formulario->pregunta_b5_4 : 'Información no registrada';
        $this->pregunta_b5_5 = !empty($formulario->pregunta_b5_5) ? $formulario->pregunta_b5_5 : 'Información no registrada';
    ...
    {
        return view('livewire.formularios.ruta-productiva.ver-encuesta');
    }
}
