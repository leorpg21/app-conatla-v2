...
class Index extends Component
{
    ...
    public $route_encuesta = "educacion.encuesta";
    public $route_ver_encuesta = "educacion.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioEducacion::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    public function render()
    {
        ...
        return view('livewire.formularios.educacion.index', [
