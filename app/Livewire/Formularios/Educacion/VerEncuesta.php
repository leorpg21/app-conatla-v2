...
class VerEncuesta extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->pregunta_b2_1 = !empty($formulario->pregunta_b2_1) ? $formulario->pregunta_b2_1 : 'Información no registrada';
        $this->pregunta_b2_2 = !empty($formulario->pregunta_b2_2) ? $formulario->pregunta_b2_2 : 'Información no registrada';
        $this->pregunta_b2_3 = !empty($formulario->pregunta_b2_3) ? $formulario->pregunta_b2_3 : 'Información no registrada';
    ...
    {
        return view('livewire.formularios.educacion.ver-encuesta');
    }
}
