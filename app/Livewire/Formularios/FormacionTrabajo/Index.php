...
use App\Livewire\Forms\Formularios\FormacionTrabajo\AgregarObservacion;
...
class Index extends Component
{
    ...
    public $route_encuesta = "formacion_trabajo.encuesta";
    public $route_ver_encuesta = "formacion_trabajo.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioFormacionTrabajo::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    {
        $beneficiarios = FormularioFormacionTrabajo::with('beneficiario')
        ...
        return view('livewire.formularios.formacion-trabajo.index', [
