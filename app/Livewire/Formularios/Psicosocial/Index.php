...
use App\Livewire\Forms\Formularios\Psicosocial\AgregarObservacion;
...
class Index extends Component
{
    ...
    public $route_encuesta = "psicosocial.encuesta";
    public $route_ver_encuesta = "psicosocial.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioPsicosocial::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    public function render()
    {
        ...
        $beneficiarios = FormularioPsicosocial::with('beneficiario')
        ...
        return view('livewire.formularios.psicosocial.index', [
