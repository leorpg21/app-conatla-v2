...
use App\Livewire\Forms\Formularios\Salud\AgregarObservacion;
...
{    
    ...
    public $route_encuesta = "salud.encuesta";
    public $route_ver_encuesta = "salud.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioSalud::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    public function render()
    {
        ...
        $beneficiarios = FormularioSalud::with('beneficiario')
        ...
        return view('livewire.formularios.salud.index', [
