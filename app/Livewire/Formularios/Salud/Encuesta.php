...
use App\Livewire\Forms\Formularios\Salud\GestionarFormulario;
...
class Encuesta extends Component
{
    ...
    public GestionarFormulario $salud;
    
    public function mount($id)
    {
        $formulario = FormularioSalud::find($id);
        $this->salud->loadPreguntasForm($id);
    ...
    public function update()
    {
        ...
        try {
            ...
            $this->salud->updateFormulario();

            session()->flash('success', 'Se ha realizado la encuesta satisfactoriamente');
            return $this->redirect(route('salud.index'), navigate: true);
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.formularios.salud.encuesta');
    }
}
