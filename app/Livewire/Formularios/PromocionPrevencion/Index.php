...
use App\Livewire\Forms\Formularios\PromocionPrevencion\AgregarObservacion;
...
class Index extends Component
{
    ...
    public $route_encuesta = "promocion_prevencion.encuesta";
    public $route_ver_encuesta = "promocion_prevencion.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioPromocionPrevencion::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    public function render()
    {
        ...
        $beneficiarios = FormularioPromocionPrevencion::with('beneficiario')
        ...
        return view('livewire.formularios.promocion-prevencion.index', [
