...
class Index extends Component
{
    ...
    public $route_encuesta = "sisben.encuesta";
    public $route_ver_encuesta = "sisben.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioSisben::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    public function render()
    {
        ...
        return view('livewire.formularios.sisben.index', [
