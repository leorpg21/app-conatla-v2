...
use App\Livewire\Forms\Formularios\ViolenciaGenero\AgregarObservacion;
...
class Index extends Component
{
    ...
    public $route_encuesta = "violencia_genero.encuesta";
    public $route_ver_encuesta = "violencia_genero.ver-encuesta";
    ...
    {
        $this->beneficiarios_cards = FormularioViolenciaGenero::get()->where('seleccionado_muestra', 'si');
        $this->gestionado = 0;
        $this->encuestado = 0;
        $this->sin_revisar = 0;
        $this->muestra = 0;
    ...
    public function render()
    {
        ...
        $beneficiarios = FormularioViolenciaGenero::with('beneficiario')
        ...
        return view('livewire.formularios.violencia-genero.index', [
