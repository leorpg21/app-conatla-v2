...
use App\Livewire\Forms\Formularios\ViolenciaGenero\GestionarFormulario;
...
class Encuesta extends Component
{
    ...
    public GestionarFormulario $violencia_genero;
    
    public function mount($id)
    {
        $formulario = FormularioViolenciaGenero::find($id);
        $this->violencia_genero->loadPreguntasForm($id);
    ...
    public function update()
    {
        ...
        try {
            ...
            $this->violencia_genero->validate();
        ...
        try {
            ...
            $this->violencia_genero->updateFormulario();

            session()->flash('success', 'Se ha realizado la encuesta satisfactoriamente');
            return $this->redirect(route('violencia_genero.index'), navigate: true);
        } catch (\Exception $e) {
    ...
    {
        return view('livewire.formularios.violencia-genero.encuesta');
    }
}
