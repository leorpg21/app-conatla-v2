<div>
    {{-- @if(session('error'))
        <x-alert.notification message="{{ session('error') }}" type="error"/>
    @endif --}}
...
<form wire:submit.prevent="update">
    ...
    {{-- Pregunta B1.1 --}}
    <x-evi.formularios.preguntas model="rumv.pregunta_b1_1">
    ...
    {{-- Pregunta B1.2 --}}
    <x-evi.formularios.preguntas model="rumv.pregunta_b1_2">
    ...
    {{-- Pregunta B1.3 --}}
    <x-evi.formularios.preguntas model="rumv.pregunta_b1_3">
    ...
    {{-- Pregunta B1.4 --}}
    <x-evi.formularios.preguntas model="rumv.pregunta_b1_4">
    ...
    {{-- Pregunta B1.5 --}}
    <x-evi.formularios.preguntas model="rumv.otro_servicio" version=2 >
        B1.5. ¿Otro servicio? ¿Cuál?
    </x-evi.formularios.preguntas>
    
    {{-- Pregunta C.1 --}}
    <x-evi.formularios.preguntas model="rumv.pregunta_c1">
        C1. ¿Considera que el servicio recibido resolvió su necesidad o asunto en esta visita?
    </x-evi.formularios.preguntas>

    {{-- Pregunta C.2 --}}
    <x-evi.formularios.preguntas model="rumv.pregunta_c2">
