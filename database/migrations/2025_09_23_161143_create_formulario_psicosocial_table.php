...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_psicosocial', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b12_1', ['si', 'no'])->nullable();
            $table->enum('pregunta_b12_2', ['si', 'no'])->nullable();
            $table->enum('pregunta_b12_3', ['si', 'no'])->nullable();
            $table->enum('pregunta_b12_4', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_psicosocial');
    }
};
