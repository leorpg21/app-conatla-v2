...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_sisben', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b10_1', ['si', 'no'])->nullable();
            $table->enum('pregunta_b10_2', ['si', 'no'])->nullable();
            $table->enum('pregunta_b10_3', ['si', 'no'])->nullable();
            $table->enum('pregunta_b10_4', ['si', 'no'])->nullable();
            $table->enum('pregunta_b10_5', ['si', 'no'])->nullable();
            $table->enum('pregunta_b10_6', ['si', 'no'])->nullable();
            $table->enum('pregunta_b10_7', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_sisben');
    }
};
