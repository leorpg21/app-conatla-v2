...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_promocion_prevencion', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b9_1', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_promocion_prevencion');
    }
};
