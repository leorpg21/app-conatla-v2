...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_espacio_protector', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b11_1', ['si', 'no'])->nullable();
            $table->enum('pregunta_b11_2', ['si', 'no'])->nullable();
            $table->enum('pregunta_b11_3', ['si', 'no'])->nullable();
            $table->enum('pregunta_b11_4', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_espacio_protector');
    }
};
