...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_educacion', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b2_1', ['si', 'no'])->nullable();
            $table->enum('pregunta_b2_2', ['si', 'no'])->nullable();
            $table->enum('pregunta_b2_3', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_educacion');
    }
};
