...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_ruta_productiva', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b5_1', ['si', 'no'])->nullable();
            $table->enum('pregunta_b5_2', ['si', 'no'])->nullable();
            $table->enum('pregunta_b5_3', ['si', 'no'])->nullable();
            $table->enum('pregunta_b5_4', ['si', 'no'])->nullable();
            $table->enum('pregunta_b5_5', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_ruta_productiva');
    }
};
