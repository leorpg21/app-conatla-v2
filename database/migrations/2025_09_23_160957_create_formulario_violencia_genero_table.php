...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_violencia_genero', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b8_1', ['si', 'no'])->nullable();
            $table->enum('pregunta_b8_2', ['si', 'no'])->nullable();
            $table->enum('pregunta_b8_3', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_violencia_genero');
    }
};
