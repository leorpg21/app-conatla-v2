...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_empleabilidad', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b4_1', ['si', 'no'])->nullable();
            $table->enum('pregunta_b4_2', ['si', 'no'])->nullable();
            $table->enum('pregunta_b4_3', ['si', 'no'])->nullable();
            $table->enum('pregunta_b4_4', ['si', 'no'])->nullable();
            $table->enum('pregunta_b4_5', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_empleabilidad');
    }
};
