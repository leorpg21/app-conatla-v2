...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario_formacion_trabajo', function (Blueprint $table) {
            $table->id();
            $table->enum('pregunta_b7_1', ['si', 'no'])->nullable();
            $table->enum('pregunta_b7_2', ['si', 'no'])->nullable();
    ...
    {
        Schema::dropIfExists('formulario_formacion_trabajo');
    }
};
